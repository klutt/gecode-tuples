...
seenio = set()
uniqio = [x for x in intoptp if x not in seenio and not seenio.add(x)]
seene = set()
...
if(len(uniqio) != len(seenio)):
    print "intopt has duplicates " + str(len(uniqio)) + " vs " + str(len(seenio))
else:
    print "intopt has " + str(len(seenio)) + " entries"
