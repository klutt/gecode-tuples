...
\begin{tikzpicture} [scale=1.8]
	...
	\begin{axis}[
	  ...
	  ymin=0, ymax=120000,
	  ylabel=runtime (ms) ] 
		\addlegendimage{/pgfplots/refstyle=IntPair Nodes}\addlegendentry{IntPair Nodes}
		\addlegendimage{/pgfplots/refstyle=Integer Nodes}\addlegendentry{Integer Nodes}
