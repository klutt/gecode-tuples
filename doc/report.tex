...
In all figures, except figure~\ref{fig:cost} the logarithmic graphs are close to straight lines. This indicates that all algorithms are logarithmic in both time and size of search tree. More importantly, this confirms that there was no complexity difference between tuple variables and integer variables when solving this problem. Tuple variables are faster, but not asymptotically faster.
